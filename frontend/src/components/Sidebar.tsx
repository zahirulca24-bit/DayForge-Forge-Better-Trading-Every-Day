...
export default function Sidebar({
  ...
  const menuItems = [
    ...
    { id: "active-trades", label: "Active Trade", icon: Activity },
    { id: "portfolio", label: "Portfolio", icon: Wallet },
    { id: "ai-review", label: "AI Review", icon: Cpu },
    ...
    >
      ...
      <div className="p-4 border-b border-slate-800 flex items-center justify-between" id="sidebar-brand-section">
        {!collapsed && (
          <div className="flex items-center space-x-2" id="sidebar-logo-text">
            ...
            <span className="font-bold text-white tracking-wider font-sans text-sm uppercase">
              ScalpEngine
            </span>
          </div>
        )}
      ...
      <div className="p-3 border-t border-slate-800" id="sidebar-footer-section">
        ...
        >
          ...
          {!collapsed && <span className="truncate">Exit Terminal</span>}
        </button>
      </div>
    </aside>
  );
